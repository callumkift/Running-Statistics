...
def LastMonth():
	...
	for i in range(len(dateList)):
		if (thisMonth == 1):
			...
			if (thisMonth -1 == dateList[i].month and date.today().year == dateList[i].year):
